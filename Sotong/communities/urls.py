...
from .views import post_list_view, post_create_form_view, post_detail_view, post_delete_view, post_update_view, post_section_view, comment_create_view, comment_delete_view, comment_update_view
...
urlpatterns = [
    ...
    path('comment/update/', comment_update_view, name='comment-update'),
